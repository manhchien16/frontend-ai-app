...
export const BOT_RES = {
  THANKS:
    "Cảm ơn bạn đã đánh giá câu trả lời, hãy tiếp tục phản hồi nếu câu hỏi chưa đúng nhé!",
  SORRY:
    "Hiện tại mình chưa thể trả lời câu hỏi của bạn, bạn vui lòng chờ mình một chút nhé!",
  ...
  HELLO:
    "Chào bạn, tôi là UTT AI Chatbot - trợ lý ảo hỗ trợ tư vấn tuyển sinh của Trường Đại học Công nghệ Giao thông vận tải, tôi có thể giúp gì cho bạn về vấn đề tuyển sinh?",
  ALERT:
